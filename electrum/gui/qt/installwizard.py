...
WIF_HELP_TEXT = (_('WIF keys are typed in PKpay, based on script type.') + '\n\n' +
                 _('A few examples') + ':\n' +
...
MSG_PASSPHRASE_WARN_ISSUE4566 = _("Warning") + ": "\
                              ...
                              + _("Due to a bug, old versions of PKpay will NOT be creating the "
...
class InstallWizard(QDialog, MessageBoxMixin, BaseWizard):
    ...
    def __init__(self, config, app, plugins, storage):
        ...
        self.setWindowTitle('Pkpay  -  ' + _('Install Wizard'))
        self.app = app
        self.config = config
    ...
    def run_and_get_wallet(self, get_wallet_from_daemon):
        ...
        self.set_layout(vbox, title=_('PKpay wallet'))
        ...
        if self.storage.requires_split():
            self.hide()
            msg = _("The wallet '{}' contains multiple accounts, which are no longer supported since PKpay 2.7.\n\n"
    ...
    def init_network(self, network):
        message = _("PKpay communicates with remote servers to get "
